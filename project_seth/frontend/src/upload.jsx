...
const Upload = ({ setSummary, setLoading, setError, setStatusText, onRegisterTrigger }) => {
  const [dragActive, setDragActive] = useState(false);
  const [selectedFile, setSelectedFile] = useState(null);
  const inputRef = useRef(null);

  // Expose a trigger function to parent (used by voice widget)
  useEffect(() => {
    if (onRegisterTrigger) {
      onRegisterTrigger(() => inputRef.current?.click());
    }
  }, [onRegisterTrigger]);
